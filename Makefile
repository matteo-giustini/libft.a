...
SRCS	= ft_atoi.c     ft_lstadd_back.c   ft_memchr.c      ft_split.c     ft_strncmp.c\
	ft_bzero.c    ft_lstadd_front.c  ft_memcmp.c      ft_strchr.c    ft_strrchr.c\
	ft_calloc.c   ft_lstclear.c      ft_memcpy.c      ft_strdup.c    ft_strnstr.c\
	...
	ft_isprint.c  ft_lstnew.c ft_putnbr_fd.c ft_strlen.c ft_itoa.c\
       	ft_lstsize.c ft_putstr_fd.c ft_strmapi.c	
